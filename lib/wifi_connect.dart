...
import 'App/Utils/network_client.dart';
  ...
  initState() {
    ...
    WiFiForIoTPlugin.loadWifiList().then((value) {
      for (int i = 0; i < value.length; i++) {
        print(value[i].ssid);
        if (value[i].ssid == "GVSENSOR123") {
          WiFiForIoTPlugin.connect(
            "GVSENSOR123", withInternet: true,
            ...
            //   "http://192.168.4.1/getdata.cmd?ssid=JioFiber-AhG8a_5G&password=12345678",
            //   MethodType.post,
