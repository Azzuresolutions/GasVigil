      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              homeScreenController.contactUS['email'] ?? "",
            ...
            Text(
              homeScreenController.contactUS['phone'] ?? "",
              style: whiteColor16TextStyleNormal,
            ),
            Divider(
              color: ColorConstants.whiteColor.withOpacity(0.5),
            ...
            Text(
              homeScreenController.contactUS['workHours'] ?? "",
              style: whiteColor16TextStyleNormal,
            ),
            Divider(
              color: ColorConstants.whiteColor.withOpacity(0.5),
            ...
            Text(
              homeScreenController.contactUS['address'] ?? "",
              style: whiteColor16TextStyleNormal,
            ),
            Divider(
              color: ColorConstants.whiteColor.withOpacity(0.5),
